...
/* It seems that aliyun (alibaba cloud) doesn't support RFC 6066 max_fragment_length
 * extension, so comment it out even though it can reduce RAM footprint largely. */
